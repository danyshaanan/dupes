...
function findDupes(options) {
  ...
  resultObject.fileName = options.fileName
...
function writeJson(resultObject, options) {
  fs.writeFileSync(resultObject.filePath, JSON.stringify(resultObject, null, 2)); //TODO: prevent error on file write fail
  logger.log('\nTo see the results, type:\ndupes-read ' + resultObject.filePath);
}
